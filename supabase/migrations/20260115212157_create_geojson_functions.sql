/*
  # Create GeoJSON Helper Functions

  1. Functions
    - `get_lineas_geojson`: Returns lineas with geometries as GeoJSON
    - `get_estructuras_geojson`: Returns estructuras with geometries as GeoJSON
    - `get_subestaciones_geojson`: Returns subestaciones with geometries as GeoJSON
    - `get_fallas_geojson`: Returns fallas with geometries as GeoJSON

  2. Purpose
    - Convert PostGIS geometry types to GeoJSON format for frontend consumption
    - Maintain type safety and proper geometry handling
*/
